...
import com.testhsql.sales.service.SaleService;
import java.io.*;
 ...
 */
@RestController(value = "Sales.SaleController")
...
public class SaleController {
    ...
    @ApiOperation(value = "Returns the list of Sale instances.")
    ...
    public Sale createSale(@RequestBody Sale instance) {
        LOGGER.debug("Create Sale with information: {}", instance);
        instance = saleService.create(instance);
        LOGGER.debug("Created Sale with information: {}", instance);
        return instance;
    }
    ...
    public Long countAllSales() {
        ...
        Long count = saleService.countAll();
        return count;
    }
    ...
    public Sale getSale(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
        ...
        Sale instance = saleService.findById(id);
        LOGGER.debug("Sale details with id: {}", instance);
        return instance;
    }
    ...
    public Sale editSale(@PathVariable(value = "id") Integer id, @RequestBody Sale instance) throws EntityNotFoundException {
        LOGGER.debug("Editing Sale with id: {}", instance.getId());
        instance.setId(id);
        instance = saleService.update(instance);
        LOGGER.debug("Sale details with id: {}", instance);
        return instance;
    }
    ...
    public boolean deleteSale(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
        ...
        Sale deleted = saleService.delete(id);
        return deleted != null;
    }
}
